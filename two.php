...
// Fetch all unique manager IDs from the manager table
try {
    $sql = "SELECT DISTINCT id FROM manager";  // Assuming 'id' is the column in the manager table
    $stmt = $pdo->getConnecetion()->query($sql);
    $managers = $stmt->fetchAll(PDO::FETCH_ASSOC);
} catch (PDOException $e) {
    $_SESSION['errors'] = ['Error fetching manager IDs: ' . $e->getMessage()];
    header("Location: two.php");
    exit;
}
// Handle POST request for submitting employee data
    ...
    <div class="container mt-5">
        ...
        <?php if (!empty($_SESSION['done'])): ?>
            <div class="alert alert-success">
                ...
                <?php endforeach; ?>
                <?php unset($_SESSION['done']); // Clear success message after displaying ?>
            </div>
        <?php endif; ?>
