...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $target_file = $employee['picture']; // Existing image
    ...
    $sql = "UPDATE employee SET name = ?, email = ?, phone = ?, manager_id = ?, picture = ? WHERE id = ?";
    $stmt = $pdo->getConnecetion()->prepare($sql);
    $stmt->execute([$name, $email, $phone, $manager_id, $target_file, $employee_id]);
    ...
    <div class="row">
        <div class="col-lg-8 mb-5 mb-lg-0">
            ...
            <div class="contact-form">
                <form method="POST" enctype="multipart/form-data" class="px-5" id="fruitkha-contact">
                    <div class="mb-3">
                        <label for="name" class="form-label">Name</label>
                        <input type="text" class="form-control" id="name" name="name" value="<?= htmlspecialchars($employee['name']) ?>">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="manager_id" name="manager_id" value="<?= htmlspecialchars($employee['manager_id']) ?>">
                    </div>
                    <div class="mb-3">
                        <label for="picture" class="form-label">Update Picture</label>
                        <input type="file" class="form-control" id="picture" name="picture">
                        <?php if (!empty($employee['picture'])): ?>
                            <p>Current Image: <img src="<?= htmlspecialchars($employee['picture']) ?>" alt="Employee Image" width="100"></p>
                        <?php endif; ?>
                    </div>
